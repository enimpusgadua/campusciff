...
![imagen repositorio] (G:\Git\campusciff\Repo enimpusgadua.png)
##2.2 Clonar el repositorio en local
###   git clone git@github.com:enimpusgadua/campusciff.git
## 2.3 Crear (si no lo habéis creado ya) en vuestro repositorio local un documento README.md
###   Fichero README.md creado a través de la opción disponible al iniciar el repositorio
